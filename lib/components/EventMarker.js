...
var EventTime = function EventTime(_ref) {
  ...
  return _react2.default.createElement(
    "text",
    { x: 0, y: 0, dy: "1.2em", className: "event-time-text" },
    text
  );
};
...
var EventMarker = function (_React$Component) {
  ...
  function EventMarker(props) {
    ...
    var _this = _possibleConstructorReturn(this, (EventMarker.__proto__ || Object.getPrototypeOf(EventMarker)).call(this, props));
  ...
  _createClass(EventMarker, [{
    ...
    key: "setInfoBoxDirection",
    value: function setInfoBoxDirection(props) {
      ...
      var t = this.getT(event);

      var posx = timeScale(t) + offsetX;
      if (posx < 10 + infoWidth && this.state.infoBoxDirection !== "right") this.setState({ infoBoxDirection: "right" });else if (posx + 10 + infoWidth > width && this.state.infoBoxDirection !== "left") this.setState({ infoBoxDirection: "left" });
    }
  }, {
    key: "getT",
    value: function getT(event) {
      var t = void 0;
    ...
    value: function renderMarker(event, column, info) {
      ...
      if (info) {
        if (_underscore2.default.isString(this.props.info)) {
          infoBox = _react2.default.createElement(_Label2.default, _extends({}, infoBoxProps, { label: info, className: "info-box" }));
        } else {
      ...
      if (this.props.type === "point") {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            "g",
            { transform: "translate(10," + (infoOffsetY + 25) + ")" },
